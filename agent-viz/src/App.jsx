      ...
      <div style={{ display: "flex", gap: 12, maxWidth: 1200, margin: "0 auto", height: "calc(100vh - 80px)" }}>
            ...
            {agents.map((a, i) => {
              ...
              return (
                <div key={i} style={{
                  ...
                  fontSize: 11, marginBottom: 5, padding: "4px 6px",
                  borderRadius: 6, background: isNew ? "#1a2744" : "transparent"
                }}>
                  <span style={{ color: isNew ? "#60a5fa" : "#e2e8f0" }}>{isNew ? "✨ " : ""}{name}</span>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#1e293b", borderRadius: 12, padding: 12, minWidth: 0 }}>
          ...
          <div ref={chatRef} style={{ flex: 1, overflowY: "auto", marginBottom: 10 }}>
            ...
            {thinking && <div style={{ color: "#6366f1", fontSize: 12, marginBottom: 8 }}>⟳ Commander is thinking...</div>}
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button onClick={send} disabled={thinking || !input.trim()} style={{
              ...
              padding: "0 16px", cursor: thinking ? "not-allowed" : "pointer",
